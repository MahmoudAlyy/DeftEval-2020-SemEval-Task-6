...
with open("sentences&def.txt") as f:
...
np.savetxt(os.path.join(here, 'doc_vec.csv'), doc_vec, delimiter=',')
doc_vec = pd.read_csv(os.path.join(here, 'doc_vec.csv'), header=None)
